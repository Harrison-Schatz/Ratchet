...
1. Worklog `done` entry: task id, what landed (merge SHA / PR URL), evidence pointer.
2. STATE.md → `status: idle`, task block cleared, "Next action" empty (or pointing at the next milestone, Tier 3).
